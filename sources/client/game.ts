 ...
 */
function turnHandler(number:number, playerMove:string, lostMoveX:number, newMoveX:number, lostMoveY:number, newMoveY:number) {
    sendMessage({
        type: 'playerRoll',
        number,
        playerMove,
 ...
 */
function changePlayer( myTurn: boolean, playerMove: string, lostMoveX: number, newMoveX: number, lostMoveY: number, newMoveY: number  ): void
{
